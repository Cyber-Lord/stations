...
class RemittanceViewSet(ModelViewSet):
    http_method_names = supported_http_method_names
    queryset = Remittance.objects.filter(status="P").order_by("-timestamp")
    ...
    def get_queryset(self):
        ...
        query_set = queryset.filter(supply__station__station_manager__user_id=self.request.user.id).order_by("-timestamp")
        return query_set
