# Generated by Django 3.2 on 2022-02-26 08:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('A', 'Accepted'), ('P', 'Pending'), ('R', 'Rejected')], default='P', max_length=15)),
                ('rejection_note', models.CharField(blank=True, max_length=500)),
                ('teller', models.ImageField(blank=True, null=True, upload_to='media/tellers')),
                ('remittance_id', models.CharField(blank=True, max_length=10)),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('supply', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.fuelsupply')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
